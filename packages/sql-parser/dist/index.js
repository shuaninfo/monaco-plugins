...
// src/mysql/index.ts
init_esm_shims();
import { createParser } from "@shuaninfo/parser";

// src/mysql/lexer.ts
init_esm_shims();
import { createLexer } from "@shuaninfo/parser";
var sqlTokenizer = createLexer([
  {
    type: "whitespace",
    regexes: [
      /^(\s+)/
...
// src/mysql/parser.ts
init_esm_shims();
import { chain as chain3, many as many2, optional as optional3, plus } from "@shuaninfo/parser";

// src/base/four-operations.ts
init_esm_shims();
import { chain, optional } from "@shuaninfo/parser";
...
// src/base/parser.ts
init_esm_shims();
import { chain as chain2, many, matchTokenType, optional as optional2 } from "@shuaninfo/parser";
...
var dataType = /* @__PURE__ */ __name(() => {
  return chain2([
    ...
    chain2("geometrycollection", "linestring", "multilinestring", "multipoint", "multipolygon", "point", "polygon")((ast) => {
      return ast[0];
    })
  ])((ast) => {
    return ast[0];
...
var setValue = /* @__PURE__ */ __name(() => {
  return chain2(wordSym, "=", [
    stringSym,
    numberSym
  ])();
}, "setValue");
var setValueList = /* @__PURE__ */ __name(() => {
  return chain2(setValue, many(",", setValue))();
}, "setValueList");
...
var stringSym = /* @__PURE__ */ __name(() => {
  return chain2(matchTokenType("string"))((ast) => {
    return ast[0];
  });
}, "stringSym");
var numberSym = /* @__PURE__ */ __name(() => {
  return chain2(matchTokenType("number"))((ast) => {
    return ast[0];
  });
}, "numberSym");
...
var root = /* @__PURE__ */ __name(() => {
  return chain3(statements, optional3(";"))((ast) => {
    return ast[0];
  });
}, "root");
var statements = /* @__PURE__ */ __name(() => {
  return chain3(statement, many2(chain3(";", statement)((ast) => {
    return ast[1];
  })))(flattenAll);
}, "statements");
...
var selectStatement = /* @__PURE__ */ __name(() => {
  return chain3("select", selectList, optional3(fromClause), optional3(orderByClause), optional3(limitClause), optional3(union, selectStatement))((ast) => {
    const result = {
      type: "statement",
      variant: "select",
      result: ast[1],
...
var fromClause = /* @__PURE__ */ __name(() => {
  return chain3("from", tableSources, optional3(whereStatement), optional3(groupByStatement), optional3(havingStatement))((ast) => {
    return {
      sources: ast[1],
      where: ast[2],
      group: ast[3],
...
var selectList = /* @__PURE__ */ __name(() => {
  return chain3(selectField, many2(selectListTail))(flattenAll);
}, "selectList");
var selectListTail = /* @__PURE__ */ __name(() => {
  return chain3(",", selectField)((ast) => {
    return ast[1];
  });
}, "selectListTail");
var selectField = /* @__PURE__ */ __name(() => {
  return chain3([
    chain3(many2("not"), [
      chain3(field, optional3(overClause))((ast) => {
        return ast[0];
      }),
      chain3("(", field, ")")()
    ], optional3(alias))((ast) => {
...
var whereStatement = /* @__PURE__ */ __name(() => {
  return chain3("where", expression)((ast) => {
    return ast[1];
  });
}, "whereStatement");
var fieldList = /* @__PURE__ */ __name(() => {
  return chain3(columnField, many2(",", columnField))();
}, "fieldList");
var tableSources = /* @__PURE__ */ __name(() => {
  return chain3(tableSource, many2(chain3(",", tableSource)((ast) => {
    return ast[1];
  })))(flattenAll);
}, "tableSources");
var tableSource = /* @__PURE__ */ __name(() => {
  return chain3(tableSourceItem, many2(joinPart))((ast) => {
    return {
      source: ast[0],
      joins: ast[1],
      type: "statement",
...
var tableSourceItem = /* @__PURE__ */ __name(() => {
  return chain3([
    chain3(tableName, optional3(alias))((ast) => {
      return {
        type: "identifier",
        variant: "table",
        name: ast[0],
...
var joinPart = /* @__PURE__ */ __name(() => {
  return chain3([
    ...
    chain3([
      "left",
      "right"
    ], optional3("outer"), "join")(),
    chain3("natural", optional3([
      "left",
      "right"
    ], optional3("outer")), "join")()
  ], tableSourceItem, optional3("on", expression))((ast) => {
    return {
      type: "statement",
      variant: "join",
      join: ast[1],
...
var createTableStatement = /* @__PURE__ */ __name(() => {
  return chain3("create", "table", stringOrWord, "(", tableOptions, ")", optional3(withStatement))();
}, "createTableStatement");
var withStatement = /* @__PURE__ */ __name(() => {
  return chain3("with", "(", withStatements, ")")();
}, "withStatement");
var withStatements = /* @__PURE__ */ __name(() => {
  return chain3(withStatementsTail, many2(",", withStatementsTail))();
}, "withStatements");
var withStatementsTail = /* @__PURE__ */ __name(() => {
  return chain3(wordSym, "=", stringSym)();
}, "withStatementsTail");
var tableOptions = /* @__PURE__ */ __name(() => {
  return chain3(tableOption, many2(",", tableOption))();
}, "tableOptions");
var tableOption = /* @__PURE__ */ __name(() => {
  return chain3(stringOrWord, dataType)();
}, "tableOption");
var tableName = /* @__PURE__ */ __name(() => {
  return chain3([
    chain3(stringOrWord)(),
    chain3(stringOrWord, ".", stringOrWord)((ast) => {
      return [
        ast[0],
        ast[2]
      ];
...
var havingStatement = /* @__PURE__ */ __name(() => {
  return chain3("having", expression)();
}, "havingStatement");
var createViewStatement = /* @__PURE__ */ __name(() => {
  return chain3("create", "view", wordSym, "as", selectStatement)();
}, "createViewStatement");
var insertStatement = /* @__PURE__ */ __name(() => {
  return chain3("insert", optional3("ignore"), "into", tableName, optional3(selectFieldsInfo), [
    selectStatement
  ])((ast) => {
    return {
      type: "statement",
...
var selectFieldsInfo = /* @__PURE__ */ __name(() => {
  return chain3("(", selectFields, ")")();
}, "selectFieldsInfo");
var selectFields = /* @__PURE__ */ __name(() => {
  return chain3(wordSym, many2(",", wordSym))();
}, "selectFields");
var groupByStatement = /* @__PURE__ */ __name(() => {
  return chain3("group", "by", fieldList)();
}, "groupByStatement");
var orderByClause = /* @__PURE__ */ __name(() => {
  return chain3("order", "by", orderByExpressionList)();
}, "orderByClause");
var orderByExpressionList = /* @__PURE__ */ __name(() => {
  return chain3(orderByExpression, many2(",", orderByExpression))();
}, "orderByExpressionList");
var orderByExpression = /* @__PURE__ */ __name(() => {
  return chain3(expression, optional3([
    "asc",
    "desc"
  ]))();
}, "orderByExpression");
var partitionByClause = /* @__PURE__ */ __name(() => {
  return chain3([
    wordSym,
    chain3("partition", "by", expression)()
  ])((ast) => {
    return ast;
  });
}, "partitionByClause");
var overClause = /* @__PURE__ */ __name(() => {
  return chain3("over", "(", overTailExpression, ")")();
}, "overClause");
var overTailExpression = /* @__PURE__ */ __name(() => {
  return chain3([
    partitionByClause,
    chain3(field, orderByClause)()
  ], many2(",", overTailExpression))();
}, "overTailExpression");
var limitClause = /* @__PURE__ */ __name(() => {
  return chain3("limit", [
    numberSym,
    chain3(numberSym, ",", numberSym)(),
    chain3(numberSym, "offset", numberSym)()
  ])();
}, "limitClause");
...
var ifFunction = /* @__PURE__ */ __name(() => {
  return chain3("if", "(", predicate, ",", field, ",", field, ")")((ast) => {
    return {
      type: "function",
      name: "if",
      args: [
...
var castFunction = /* @__PURE__ */ __name(() => {
  return chain3("cast", "(", field, "as", dataType, ")")((ast) => {
    return {
      type: "function",
      name: "cast",
      args: [
...
var normalFunction = /* @__PURE__ */ __name(() => {
  return chain3(wordSym, "(", optional3(functionFields), ")", optional3("filter", "(", whereStatement, ")"))((ast) => {
    return {
      type: "function",
      name: ast[0],
      args: ast[2]
...
var functionFields = /* @__PURE__ */ __name(() => {
  return chain3(functionFieldItem, many2(",", functionFieldItem))();
}, "functionFields");
var functionFieldItem = /* @__PURE__ */ __name(() => {
  return chain3(many2(selectSpec), [
    columnField,
    caseStatement
  ])((ast) => {
    return ast;
...
var caseStatement = /* @__PURE__ */ __name(() => {
  return chain3("case", plus(caseAlternative), optional3("else", [
    columnField,
    "null"
  ]), [
    "end",
    chain3("end", "as", wordSym)()
  ])();
}, "caseStatement");
var caseAlternative = /* @__PURE__ */ __name(() => {
  return chain3("when", expression, "then", fieldItem)();
}, "caseAlternative");
var setStatement = /* @__PURE__ */ __name(() => {
  return chain3("set", variableAssignments)();
}, "setStatement");
var variableAssignments = /* @__PURE__ */ __name(() => {
  return chain3(variableAssignment, many2(",", variableAssignment))();
}, "variableAssignments");
var variableAssignment = /* @__PURE__ */ __name(() => {
  return chain3(variableLeftValue, "=", [
    "true",
    "false",
    stringSym,
    numberSym
...
var expression = /* @__PURE__ */ __name(() => {
  return chain3(expressionHead, many2(logicalOperator, expression))(flattenAll);
}, "expression");
var expressionHead = /* @__PURE__ */ __name(() => {
  return chain3([
    chain3("(", expression, ")")(),
    chain3(notOperator, expression)(),
    chain3(booleanPrimary)
  ], optional3(chain3("is", optional3("not"), [
    "true",
    "false",
    "unknown"
  ])()))((ast) => {
...
var predicate = /* @__PURE__ */ __name(() => {
  return chain3([
    chain3(columnField, predicateAddonComparison)(),
    chain3("(", predicate, ")", predicateAddonComparison)()
  ])();
}, "predicate");
var predicateAddonComparison = /* @__PURE__ */ __name(() => {
  return chain3(optional3([
    chain3(comparisonOperator, columnField)(),
    chain3("sounds", "like", columnField)(),
    isOrNotExpression
  ]), optional3([
    "or",
    predicate
...
var isOrNotExpression = /* @__PURE__ */ __name(() => {
  return chain3(optional3("is"), optional3("not"), [
    chain3("in", "(", [
      selectStatement,
      fieldList
    ], ")")(),
    chain3("between", field, "and", predicate)(),
    chain3("like", field, optional3("escape", field))(),
    chain3("regexp", field)(),
    "null"
  ])();
}, "isOrNotExpression");
var fieldItem = /* @__PURE__ */ __name(() => {
  return chain3(fieldItemDetail, many2(normalOperator, fieldItemDetail))((ast) => {
    if (!ast[1]) {
      return ast[0];
    }
    return [
...
var fieldItemDetail = /* @__PURE__ */ __name(() => {
  return chain3([
    functionChain,
    caseStatement,
    chain3(stringOrWordOrNumber, optional3([
      chain3(".", "*")((ast) => {
        return {
          type: "identifier",
          variant: "groupAll"
...
var createIndexStatement = /* @__PURE__ */ __name(() => {
  return chain3("create", "index", indexItem, onStatement, whereStatement)();
}, "createIndexStatement");
var indexItem = /* @__PURE__ */ __name(() => {
  return chain3(stringSym, many2(".", stringSym))();
}, "indexItem");
var onStatement = /* @__PURE__ */ __name(() => {
  return chain3("ON", stringSym, "(", fieldForIndexList, ")")();
}, "onStatement");
var fieldForIndex = /* @__PURE__ */ __name(() => {
  return chain3(stringSym, optional3([
    "ASC",
    "DESC"
  ]))();
}, "fieldForIndex");
var fieldForIndexList = /* @__PURE__ */ __name(() => {
  return chain3(fieldForIndex, many2(",", fieldForIndex))();
}, "fieldForIndexList");
var createFunctionStatement = /* @__PURE__ */ __name(() => {
  return chain3("create", "function", wordSym, "as", stringSym)();
}, "createFunctionStatement");
var updateStatement = /* @__PURE__ */ __name(() => {
  return chain3("UPDATE", tableSourceItem, "SET", setValueList, optional3(whereStatement))();
}, "updateStatement");

// src/mysql/index.ts
var mysqlParser = createParser(root, sqlTokenizer, {
